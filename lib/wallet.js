...
exports.encodeProtoruneHolders = encodeProtoruneHolders;
...
const { ProtorunesWalletRequest, ProtoruneHoldersRequest, TransactionRecord, WalletRequest, WalletResponse, RuntimeInput, Runtime, Outpoint, } = protorune_1.protorune;
/**
...
function encodeProtoruneHolders(id, protocolTag) {
    const input = {
        id: Uint8Array.from(Buffer.from(id, "utf-8")),
        protocol_tag: encodeProtocolTag(protocolTag),
    };
    return ("0x" +
