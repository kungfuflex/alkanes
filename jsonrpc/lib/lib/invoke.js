...
function decodeAlkaneInventoryResponse(hex) {
    const res = alkanes_1.alkanes.AlkaneInventoryResponse.deserializeBinary(Buffer.from((0, utils_1.stripHexPrefix)(hex), "hex"));
...
function decodeAlkaneStorageResponse(hex) {
    const res = alkanes_1.alkanes.AlkaneStorageResponse.deserializeBinary(Buffer.from((0, utils_1.stripHexPrefix)(hex), "hex"));
