...
(function (alkanes) {
    ...
    class MultiSimulateRequest extends pb_1.Message {
        constructor(data) {
            super();
            _MultiSimulateRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _MultiSimulateRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("parcels" in data && data.parcels != undefined) {
                    this.parcels = data.parcels;
                }
            }
        }
        get parcels() {
            return pb_1.Message.getRepeatedWrapperField(this, MessageContextParcel, 1);
        }
        set parcels(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data) {
            const message = new MultiSimulateRequest({});
            if (data.parcels != null) {
                message.parcels = data.parcels.map(item => MessageContextParcel.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.parcels != null) {
                data.parcels = this.parcels.map((item) => item.toObject());
            }
            return data;
        }
        serialize(w) {
            ...
            if (this.parcels.length)
                writer.writeRepeatedMessage(1, this.parcels, (item) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MultiSimulateRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.parcels, () => pb_1.Message.addToRepeatedWrapperField(message, 1, MessageContextParcel.deserialize(reader), MessageContextParcel));
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes) {
            return MultiSimulateRequest.deserialize(bytes);
        }
    }
    _MultiSimulateRequest_one_of_decls = new WeakMap();
    alkanes.MultiSimulateRequest = MultiSimulateRequest;
    ...
    class AlkanesBlockEvent extends pb_1.Message {
        constructor(data) {
            super();
            _AlkanesBlockEvent_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AlkanesBlockEvent_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get traces() {
            return pb_1.Message.getWrapperField(this, AlkanesTrace, 1);
        }
        set traces(value) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
    ...
    _AlkanesBlockEvent_one_of_decls = new WeakMap();
    alkanes.AlkanesBlockEvent = AlkanesBlockEvent;
    class AlkanesBlockTraceEvent extends pb_1.Message {
        constructor(data) {
            super();
            _AlkanesBlockTraceEvent_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _AlkanesBlockTraceEvent_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get events() {
            return pb_1.Message.getRepeatedWrapperField(this, AlkanesBlockEvent, 1);
        }
        set events(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
    ...
    _AlkanesBlockTraceEvent_one_of_decls = new WeakMap();
    alkanes.AlkanesBlockTraceEvent = AlkanesBlockTraceEvent;
    ...
    class MultiSimulateResponse extends pb_1.Message {
        constructor(data) {
            super();
            _MultiSimulateResponse_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _MultiSimulateResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get responses() {
            return pb_1.Message.getRepeatedWrapperField(this, SimulateResponse, 1);
        }
        set responses(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        ...
        static fromObject(data) {
            const message = new MultiSimulateResponse({});
            if (data.responses != null) {
                message.responses = data.responses.map(item => SimulateResponse.fromObject(item));
            }
            if (data.error != null) {
                message.error = data.error;
            }
        ...
        serialize(w) {
            ...
            if (this.responses.length)
                writer.writeRepeatedMessage(1, this.responses, (item) => item.serialize(writer));
            if (this.error.length)
        ...
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MultiSimulateResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.responses, () => pb_1.Message.addToRepeatedWrapperField(message, 1, SimulateResponse.deserialize(reader), SimulateResponse));
                        break;
                    case 2:
                        message.error = reader.readString();
                        break;
        ...
        static deserializeBinary(bytes) {
            return MultiSimulateResponse.deserialize(bytes);
        }
    }
    _MultiSimulateResponse_one_of_decls = new WeakMap();
    alkanes.MultiSimulateResponse = MultiSimulateResponse;
    ...
    class AlkaneIdToOutpointRequest extends pb_1.Message {
        constructor(data) {
            super();
            _AlkaneIdToOutpointRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AlkaneIdToOutpointRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("id" in data && data.id != undefined) {
                    this.id = data.id;
                }
        ...
        static fromObject(data) {
            const message = new AlkaneIdToOutpointRequest({});
            if (data.id != null) {
                message.id = AlkaneId.fromObject(data.id);
            }
            return message;
        ...
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new AlkaneIdToOutpointRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes) {
            return AlkaneIdToOutpointRequest.deserialize(bytes);
        }
    }
    _AlkaneIdToOutpointRequest_one_of_decls = new WeakMap();
    alkanes.AlkaneIdToOutpointRequest = AlkaneIdToOutpointRequest;
    ...
    class AlkaneStorageRequest extends pb_1.Message {
        constructor(data) {
            super();
            _AlkaneStorageRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AlkaneStorageRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("id" in data && data.id != undefined) {
                    this.id = data.id;
                }
        ...
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new AlkaneStorageRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes) {
            return AlkaneStorageRequest.deserialize(bytes);
        }
    }
    _AlkaneStorageRequest_one_of_decls = new WeakMap();
    alkanes.AlkaneStorageRequest = AlkaneStorageRequest;
    class AlkaneStorageResponse extends pb_1.Message {
        constructor(data) {
            super();
            _AlkaneStorageResponse_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AlkaneStorageResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("value" in data && data.value != undefined) {
                    this.value = data.value;
                }
        ...
        static fromObject(data) {
            const message = new AlkaneStorageResponse({});
            if (data.value != null) {
                message.value = data.value;
            }
            return message;
        ...
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new AlkaneStorageResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes) {
            return AlkaneStorageResponse.deserialize(bytes);
        }
    }
    _AlkaneStorageResponse_one_of_decls = new WeakMap();
    alkanes.AlkaneStorageResponse = AlkaneStorageResponse;
    class AlkaneIdToOutpointResponse extends pb_1.Message {
        constructor(data) {
            super();
            _AlkaneIdToOutpointResponse_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AlkaneIdToOutpointResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        static fromObject(data) {
            const message = new AlkaneIdToOutpointResponse({});
            if (data.txid != null) {
        ...
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new AlkaneIdToOutpointResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes) {
            return AlkaneIdToOutpointResponse.deserialize(bytes);
        }
    }
    _AlkaneIdToOutpointResponse_one_of_decls = new WeakMap();
    alkanes.AlkaneIdToOutpointResponse = AlkaneIdToOutpointResponse;
    ...
    alkanes.Outpoint = Outpoint;
    class Trace extends pb_1.Message {
        constructor(data) {
            super();
            _Trace_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Trace_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("outpoint" in data && data.outpoint != undefined) {
                    this.outpoint = data.outpoint;
                }
        ...
        get trace() {
            return pb_1.Message.getWrapperField(this, AlkanesTrace, 2);
        }
        set trace(value) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
    ...
    _Trace_one_of_decls = new WeakMap();
    alkanes.Trace = Trace;
    class TraceBlockRequest extends pb_1.Message {
        constructor(data) {
            super();
            _TraceBlockRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _TraceBlockRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("block" in data && data.block != undefined) {
                    this.block = data.block;
                }
    ...
    _TraceBlockRequest_one_of_decls = new WeakMap();
    alkanes.TraceBlockRequest = TraceBlockRequest;
    class TraceBlockResponse extends pb_1.Message {
        constructor(data) {
            super();
            _TraceBlockResponse_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _TraceBlockResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("traces" in data && data.traces != undefined) {
                    this.traces = data.traces;
                }
        ...
        get traces() {
            return pb_1.Message.getRepeatedWrapperField(this, Trace, 1);
        }
        set traces(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        ...
        toObject() {
            const data = {};
            if (this.traces != null) {
                data.traces = this.traces.map((item) => item.toObject());
            }
            return data;
        }
        serialize(w) {
            ...
            if (this.traces.length)
                writer.writeRepeatedMessage(1, this.traces, (item) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    _TraceBlockResponse_one_of_decls = new WeakMap();
    alkanes.TraceBlockResponse = TraceBlockResponse;
    class BytecodeRequest extends pb_1.Message {
        constructor(data) {
            super();
            _BytecodeRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _BytecodeRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("id" in data && data.id != undefined) {
                    this.id = data.id;
                }
    ...
    _BytecodeRequest_one_of_decls = new WeakMap();
    alkanes.BytecodeRequest = BytecodeRequest;
    class BlockRequest extends pb_1.Message {
        constructor(data) {
            super();
            _BlockRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _BlockRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("height" in data && data.height != undefined) {
                    this.height = data.height;
                }
    ...
    _BlockRequest_one_of_decls = new WeakMap();
    alkanes.BlockRequest = BlockRequest;
    class BlockResponse extends pb_1.Message {
        constructor(data) {
            super();
            _BlockResponse_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _BlockResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("block" in data && data.block != undefined) {
                    this.block = data.block;
                }
        ...
        serialize(w) {
            const writer = w || new pb_1.BinaryWriter();
            if (this.block.length)
                writer.writeBytes(1, this.block);
            if (this.height != 0)
