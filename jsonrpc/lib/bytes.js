...
const alkanes_js_1 = require("./proto/alkanes.js");
function toProtobufAlkaneTransfer(v) {
    return new alkanes_js_1.alkanes.AlkaneTransfer({
        id: new alkanes_js_1.alkanes.AlkaneId({
...
function toUint128(v) {
    ...
    return new alkanes_js_1.alkanes.uint128({
