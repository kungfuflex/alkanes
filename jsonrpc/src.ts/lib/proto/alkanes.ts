...
export namespace alkanes {
    ...
    export class MultiSimulateRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
        ...
        get parcels() {
            return pb_1.Message.getRepeatedWrapperField(this, MessageContextParcel, 1) as MessageContextParcel[];
        }
        set parcels(value: MessageContextParcel[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            parcels?: ReturnType<typeof MessageContextParcel.prototype.toObject>[];
        ...
        toObject() {
            ...
            if (this.parcels != null) {
                data.parcels = this.parcels.map((item: MessageContextParcel) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.parcels.length)
                writer.writeRepeatedMessage(1, this.parcels, (item: MessageContextParcel) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MultiSimulateRequest {
        ...
        static deserializeBinary(bytes: Uint8Array): MultiSimulateRequest {
    ...
    export class MultiSimulateResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
        ...
        get responses() {
            return pb_1.Message.getRepeatedWrapperField(this, SimulateResponse, 1) as SimulateResponse[];
        }
        set responses(value: SimulateResponse[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        get error() {
        ...
        static fromObject(data: {
            responses?: ReturnType<typeof SimulateResponse.prototype.toObject>[];
            error?: string;
        ...
        toObject() {
            ...
            if (this.responses != null) {
                data.responses = this.responses.map((item: SimulateResponse) => item.toObject());
            }
            if (this.error != null) {
                data.error = this.error;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.responses.length)
                writer.writeRepeatedMessage(1, this.responses, (item: SimulateResponse) => item.serialize(writer));
            if (this.error.length)
                writer.writeString(2, this.error);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MultiSimulateResponse {
        ...
        static deserializeBinary(bytes: Uint8Array): MultiSimulateResponse {
    ...
    export class AlkaneIdToOutpointRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            id?: AlkaneId;
        }) {
    ...
    export class AlkaneStorageRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            id?: AlkaneId;
            path?: Uint8Array;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AlkaneStorageRequest {
        ...
        static deserializeBinary(bytes: Uint8Array): AlkaneStorageRequest {
            return AlkaneStorageRequest.deserialize(bytes);
        }
    }
    export class AlkaneStorageResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            value?: Uint8Array;
        }) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AlkaneStorageResponse {
        ...
        static deserializeBinary(bytes: Uint8Array): AlkaneStorageResponse {
            return AlkaneStorageResponse.deserialize(bytes);
        }
    }
    export class AlkaneIdToOutpointResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            txid?: Uint8Array;
            vout?: number;
